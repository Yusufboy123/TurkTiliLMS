...
| ------------------------ | ----------------------------------------- | -------: | ------------------- | ----------------------------------------------------------- |
| Home                     | `/`                                       |       P0 | Specified           | Module 9.5A contract; Module 9.5D runtime                   |
| Public demo lesson       | `/demo/turk-alfabesi`                     |       P0 | Specified           | Module 9.5A contract; Modules 9.5C–9.5D runtime             |
...
| Course player      | `/learn/:enrollmentId/lessons/:lessonId` |       P0 | Partially Specified | Module #8 progress plus Module 9.5F exercises |
...
| Page               | Suggested route                                        | Priority | Status              | Access/dependency                                                                                                                                                                                                                                         |
| ------------------ | ------------------------------------------------------ | -------: | ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Dashboard          | `/admin`                                               |       P1 | Partially Specified | Module 9.4A architecture approval and Module 9.4B summary runtime are required before Module 9.4C registers the route and changes the admin post-login redirect.                                                                                          |
...
| Exercise library   | `/admin/exercises`                                     |       P1 | Specified           | Module 9.5C typed APIs and 9.5D graphical lifecycle editors                                                                                                                                                                                               |
| Exercise editor    | `/admin/exercises/:exerciseId`                         |       P1 | Specified           | Revisions, localization, grading boundary, media usage, review/publish/archive/restore                                                                                                                                                                    |
| Demo configuration | `/admin/content/public-demo`                           |       P1 | Specified           | Landing content, demo mapping, placements/reorder, preview, publication, and audit in Modules 9.5C–9.5D                                                                                                                                                   |
...
| O‘zlashtirish      | `/admin/progress`                                      |       P2 | Specified           | Implemented by Module 8.4; requires ADMIN and `progress.read`.                                                                                                                                                                                            |
